import { Box, Bike, Crosshair, Circle, Target, Egg, Square, Sword, Cuboid, Cctv, Trophy, Goal, Car, Swords, Grid3x3, Heart, Route, Flame, Crown, Gauge, Bomb, Layers, Users, Snowflake, Clock, MessageSquare, Home, Zap } from "lucide-react";
...
export const ALL_GAMES: GameEntry[] = [
  ...
  { href: "/bikers-republic", label: "Bikers Republic", icon: Bomb },
